...
from .fsxdataset import FSXIterableDataset
...
class ImageNetFSX(IterableDataset):
    ...
    def __init__(self, data_prefix, pipeline, ann_file=None, test_mode=False):
        self.url_list = ["/mnt/fsx2/imagenet_web_dataset/train/imagenet-train-{}.tar".format(str(filenum).zfill(6)) for filenum in range(1282)]
    ...
    def __iter__(self):
        self.s3_iter_dataset = FSXIterableDataset(self.url_list, shuffle_urls=True)
