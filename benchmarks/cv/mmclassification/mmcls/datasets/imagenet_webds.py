...
class ImageNetWeb(WebDataset):
    ...
    def __init__(self, data_prefix, pipeline, length, test_mode=False,  shard_selection=worker_urls):
        super(ImageNetWeb, self).__init__(data_prefix, shard_selection=shard_selection)
        self.CLASSES = ['n01440764', 'n01443537', 'n01484850', 'n01491361', 'n01494475', 'n01496331', 'n01498041',
